  ...
  var methods = {
    init: function (options) {
      var defaults = {
          ...
          mouseWheel:
            "pixels" /*mousewheel support and velocity: boolean, "auto", integer, "pixels"*/,
      ...
      return this.each(function () {
        ...
        $this
          .wrapInner(
            "<div class='mCustomScrollBox' id='mCSB_" +
              $(document).data("mCustomScrollbar-index") +
        ...
        mCSB_container.after(
          "<div class='mCSB_scrollTools' style='position:absolute;'><div class='mCSB_draggerContainer' style='position:relative;'><div class='mCSB_dragger' style='position:absolute;'><div class='mCSB_dragger_bar' style='position:relative;'></div></div><div class='mCSB_draggerRail'></div></div></div>"
        );
        ...
        if (options.scrollButtons.enable) {
          if (options.horizontalScroll) {
            mCSB_scrollTools
              .prepend(
                "<a class='mCSB_buttonLeft' style='display:block; position:relative;'></a>"
              )
              .append(
                "<a class='mCSB_buttonRight' style='display:block; position:relative;'></a>"
              );
          } else {
            mCSB_scrollTools
              .prepend(
          ...
          if ($this.css("max-height") !== "none") {
            $this.data({
              ...
              mCS_maxHeight_Interval: setInterval(function () {
                ...
                if (
                  mCSB_container.outerHeight() > $this.data("mCS_maxHeight")
                ) {
    ...
    update: function () {
      ...
      if (
        ...
        var mCSB_containerP = Math.abs(
          Math.round(mCSB_container.position().top)
        );
        ...
        var mCSB_containerP = Math.abs(
          Math.round(mCSB_container.position().left)
        );
      ...
      if (!$this.data("bindEvent_scrollbar_click")) {
        ...
        mCSB_draggerContainer.bind("click", function (e) {
          if ($this.data("horizontalScroll")) {
            ...
            if (
              mouseCoord < mCSB_dragger.position().left ||
              mouseCoord > mCSB_dragger.position().left + mCSB_dragger.width()
            ) {
            ...
            if (
              mouseCoord < mCSB_dragger.position().top ||
              mouseCoord > mCSB_dragger.position().top + mCSB_dragger.height()
            ) {
              var scrollToPos = mouseCoord;
          ...
          mCustomScrollBox.bind("mousewheel", function (event, delta) {
            ...
            if ($this.data("horizontalScroll")) {
              if ($this.data("mouseWheel") === "pixels") {
                ...
                var scrollTo =
                  Math.abs(Math.round(mCSB_container.position().left)) -
                  delta * $this.data("mouseWheelPixels");
              ...
              if ($this.data("mouseWheel") === "pixels") {
                ...
                var scrollTo =
                  Math.abs(Math.round(mCSB_container.position().top)) -
                  delta * $this.data("mouseWheelPixels");
        ...
        if ($this.data("scrollButtons_scrollType") === "pixels") {
          ...
          if ($this.data("horizontalScroll")) {
            mCSB_buttonRight
              .add(mCSB_buttonLeft)
              .unbind(
                "mousedown touchstart onmsgesturestart mouseup mouseout touchend onmsgestureend",
          ...
          if ($this.data("horizontalScroll")) {
            ...
            if (!$this.data("bindEvent_buttonsContinuous_x")) {
              ...
              mCSB_buttonRight.bind(
                "mousedown touchstart onmsgesturestart",
                function (e) {
                  e.preventDefault();
                  ...
                  $this.data({
                    mCSB_buttonScrollRight: setInterval(function () {
                      var scrollTo = Math.round(
                        (Math.abs(Math.round(mCSB_container.position().left)) +
                          $this.data("scrollButtons_scrollSpeed")) /
              ...
              mCSB_buttonRight.bind(
                "mouseup touchend onmsgestureend mouseout",
                mCSB_buttonRight_stop
              );
          ...
          mCustomScrollBox.bind("focusin", function () {
            ...
            if (
              ...
              if ($this.data("horizontalScroll")) {
                ...
                if (
                  mCSB_containerX + focusedElemX >= 0 &&
                  mCSB_containerX + focusedElemX <=
                    mCustomScrollBoxW - focusedElemW
                ) {
                  /*just focus...*/
                } else {
                  /*scroll, then focus*/
                ...
                if (
                  mCSB_containerY + focusedElemY >= 0 &&
                  mCSB_containerY + focusedElemY <=
                    mCustomScrollBoxH - focusedElemH
                ) {
                  /*just focus...*/
                } else {
                  /*scroll, then focus*/
          ...
          mCSB_dragger.bind("touchmove onmsgesturechange", function (e) {
            ...
            if ($this.data("horizontalScroll")) {
              $this.mCustomScrollbar(
                "scrollTo",
                mCSB_dragger.position().left - mCSB_draggerTouchX + x,
                { moveDragger: true }
              );
            } else {
              $this.mCustomScrollbar(
                "scrollTo",
                mCSB_dragger.position().top - mCSB_draggerTouchY + y,
                { moveDragger: true }
              );
            }
          });
    ...
    scroll: function (bypassCallbacks) {
      ...
      if ($.browser.webkit) {
        ...
        var screenCssPixelRatio = (window.outerWidth - 8) / window.innerWidth,
          isZoomed = screenCssPixelRatio < 0.98 || screenCssPixelRatio > 1.02;
      }
      ...
      if ($this.data("scrollInertia") === 0 || isZoomed) {
        ...
        if ($this.data("horizontalScroll")) {
          mCSB_container
            ...
            .animate(
              { left: "-=" + posX },
              $this.data("scrollInertia"),
              $this.data("scrollEasing"),
              function () {
                if (!bypassCallbacks) {
                  $this.mCustomScrollbar(
                    "callbacks",
    ...
    callbacks: function (callback) {
      ...
      switch (callback) {
        ...
        case "whileScrolling":
          if (
            $this.data("whileScrolling_Callback") &&
            !$this.data("whileScrolling")
          ) {
            $this.data({
    ...
    disable: function (resetScroll) {
      ...
      $this
        .data({ bindEvent_mousewheel: false, bindEvent_focusin: false })
    ...
    destroy: function () {
      ...
      $this
        .html(content)
        .removeClass(
          "mCustomScrollbar _mCS_" + $(document).data("mCustomScrollbar-index")
        )
